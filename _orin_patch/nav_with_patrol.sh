...
# ALWAYS START CLEAN
# =========================
timeout 1 ros2 topic pub --once /controller/cmd_vel geometry_msgs/msg/Twist "{}" >/tmp/c9_stop_cmd.log 2>&1 || true
timeout 1 ros2 topic pub --once /cmd_vel geometry_msgs/msg/Twist "{}" >>/tmp/c9_stop_cmd.log 2>&1 || true
...
tmux send-keys -t $SESSION \
  "ros2 launch isabel emma.launch.py & sleep 2; ros2 launch carolina nav.launch.py use_rviz:=false" C-m
